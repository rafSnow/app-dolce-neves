    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div className="bg-orange-50/50 p-4 rounded-xl border border-orange-100 flex flex-col gap-2">
        <label htmlFor="tipoEscala" className="block text-sm font-bold text-dolce-marrom">
          Modo de Consumo / Escala no Pedido
        </label>
        <select
          id="tipoEscala"
          {...register('tipoEscala')}
        ...
        >
          <option value="proporcional">Multiplica pela quantidade (Ingredientes como Farinha, Leite)</option>
          <option value="por_produto">1x por Sabor Diferente (Gás, Luva) - Ignora a Quantidade do pedido</option>
          <option value="por_pedido">1x por Pedido Inteiro (Touca, Limpeza) - Ignora Sabores e Quantidade</option>
        </select>
        <p className="text-xs text-dolce-marrom/70 mt-1">
          Escolha como este insumo deve se comportar quando o cliente pedir várias quantidades ou vários sabores diferentes na mesma encomenda.
        </p>
      </div>
